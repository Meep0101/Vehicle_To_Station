...
public class DragAndDrop : MonoBehaviour
{
    ...
    private Vector3 initialPosition;
    private Terminal terminal;
    private GameObject itemInsideStation;
    ...
    {
        // Destroy the previous item inside the station if any
        if (itemInsideStation != null)
        {
            Destroy(itemInsideStation);
        }

        // Instantiate the new item based on the specified shape
        switch (shape)
        {
            case "Circle":
                itemInsideStation = Instantiate(Resources.Load("Prefabs/Vehicle/Circle (1)"), terminal.transform.position, Quaternion.identity) as GameObject;
                break;
            case "Triangle":
                itemInsideStation = Instantiate(Resources.Load("Prefabs/Vehicle/Triangle"), terminal.transform.position, Quaternion.identity) as GameObject;
                break;
            case "Square":
                itemInsideStation = Instantiate(Resources.Load("Prefabs/Vehicle/Square"), terminal.transform.position, Quaternion.identity) as GameObject;
                break;
            case "IsomorphicTriangle":
                itemInsideStation = Instantiate(Resources.Load("Prefabs/Vehicle/IsomorphicTriangle"), terminal.transform.position, Quaternion.identity) as GameObject;
                break;
